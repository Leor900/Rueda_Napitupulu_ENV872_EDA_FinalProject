...
```{r Getting the working directory and loading packages, echo=FALSE}
...
colnames(AQI_Mig.outflows_by.state_2010_2020)[11] = "Migrants.outflows" # Changing the name of the variable with information of the code state

AQI_Mig.outflows_by.state_2010_2020 = subset(AQI_Mig.outflows_by.state_2010_2020, select = -c(y2_statefips, y2_state_name, n1, AGI))

write.csv(Annual_AQI_by_state_2010_2020, file = "./Data/Processed/AQI_Mig.outflows_by.state_2010_2020.csv", row.names=FALSE)

cor.test(AQI_Mig.outflows_by.state_2010_2020$Avg.Unhealthy.Days, AQI_Mig.outflows_by.state_2010_2020$Migrants.outflows)

cor.test(AQI_Mig.outflows_by.state_2010_2020$Avg.Max.AQI, AQI_Mig.outflows_by.state_2010_2020$Migrants.outflows)

cor.test(AQI_Mig.outflows_by.state_2010_2020$Avg.Days.PM2.5, AQI_Mig.outflows_by.state_2010_2020$Migrants.outflows)
```
