...
**5.Maps AQI by State 2012 and 2020**

```{r AQI by State 2012 and 2020, echo=FALSE, message=FALSE, warning=FALSE}

################################################
#   Map Average Unhealthy Days by State 2012   #
################################################

# Changing the name of the variable "State" to "state", so we can use plot_usmap 
colnames(AQI_Mig.outflows_by.state_2012_2020)[3] = "state"  

# Dataset for the Map of Average Unhealthy Days by State in 2012
data.map_unhealthy_days_2012 <- AQI_Mig.outflows_by.state_2012_2020 %>%  filter(Year==2012) %>% subset(select = c(state, Avg.Unhealthy.Days))

# Map of Average Unhealthy Days by State in 2012
map_unhealthy_days_2012 <- plot_usmap(data = data.map_unhealthy_days_2012, values = "Avg.Unhealthy.Days", labels = TRUE, label_color = "white") + labs(title = "Average Unhealthy Days by State", subtitle = "2012") + 
scale_fill_continuous(type = "viridis", name = "Average Unhealthy Days") + theme(legend.position = "right", plot.title = element_text(hjust = 0.5, face = "bold"), plot.subtitle = element_text(hjust = 0.5))

map_unhealthy_days_2012$layers[[2]]$aes_params$size <- 2.5 #Change the size of the labels on the map
print(map_unhealthy_days_2012)
...
data.map_unhealthy_days_2020 <- AQI_Mig.outflows_by.state_2012_2020 %>%  filter(Year==2020) %>% subset(select = c(state, Avg.Unhealthy.Days))

# Map of Average Unhealthy Days by State in 2020
map_unhealthy_days_2020 <- plot_usmap(data = data.map_unhealthy_days_2020, values = "Avg.Unhealthy.Days", labels = TRUE, label_color = "white") + labs(title = "Average Unhealthy Days by State", subtitle = "2020") + 
scale_fill_continuous(type = "viridis", name = "Average Unhealthy Days") + theme(legend.position = "right", plot.title = element_text(hjust = 0.5, face = "bold"), plot.subtitle = element_text(hjust = 0.5))

map_unhealthy_days_2020$layers[[2]]$aes_params$size <- 2.5 #Change the size of the labels on the map
print(map_unhealthy_days_2020)

#############################################
#   Map Average Air Quality by State 2012   #
#############################################

# Dataset for the Map of Avg Max AQI by State in 2012
data.map_max_AQI_2012 <- AQI_Mig.outflows_by.state_2012_2020 %>%  filter(Year==2012) %>% subset(select = c(state, Avg.Max.AQI))

# Map of Average Max AQI by State in 2012
map_max_AQI_2012 <- plot_usmap(data = data.map_max_AQI_2012, values = "Avg.Max.AQI", labels = TRUE, label_color = "white") + labs(title = "Average Max AQI by State", subtitle = "2012") + scale_fill_continuous(type = "viridis", name = "Average Max AQI") + theme(legend.position = "right", plot.title = element_text(hjust = 0.5, face = "bold"), plot.subtitle = element_text(hjust = 0.5))

map_max_AQI_2012$layers[[2]]$aes_params$size <- 2.5 #Change the size of the labels on the map
print(map_max_AQI_2012)
...
data.map_max_AQI_2020 <- AQI_Mig.outflows_by.state_2012_2020 %>%  filter(Year==2020) %>% subset(select = c(state, Avg.Max.AQI))

# Map of Average Max AQI by State in 2020
map_max_AQI_2020 <- plot_usmap(data = data.map_max_AQI_2020, values = "Avg.Max.AQI", labels = TRUE, label_color = "white") + labs(title = "Average Max AQI by State", subtitle = "2020") + scale_fill_continuous(type = "viridis", name = "Average Max AQI") + theme(legend.position = "right", plot.title = element_text(hjust = 0.5, face = "bold"), plot.subtitle = element_text(hjust = 0.5))

map_max_AQI_2020$layers[[2]]$aes_params$size <- 2.5 #Change the size of the labels on the map
print(map_max_AQI_2020)

############################################
#   Map Average Days PM2.5 by State 2012   #
############################################

# Dataset for the Map of Avg Days PM2.5 by State in 2012
data.map_avg_PM2.5_2012 <- AQI_Mig.outflows_by.state_2012_2020 %>%  filter(Year==2012) %>% subset(select = c(state, Avg.Days.PM2.5))

# Map of Average Days PM2.5 by State in 2012
map_avg_PM2.5_2012 <- plot_usmap(data = data.map_avg_PM2.5_2012, values = "Avg.Days.PM2.5", labels = TRUE, label_color = "white") + labs(title = "Average Days PM2.5", subtitle = "2012") + scale_fill_continuous(type = "viridis", name = "Average Days PM2.5") + theme(legend.position = "right", plot.title = element_text(hjust = 0.5, face = "bold"), plot.subtitle = element_text(hjust = 0.5))

map_avg_PM2.5_2012$layers[[2]]$aes_params$size <- 2.5 #Change the size of the labels on the map
print(map_avg_PM2.5_2012)
...
data.map_avg_PM2.5_2020 <- AQI_Mig.outflows_by.state_2012_2020 %>%  filter(Year==2020) %>% subset(select = c(state, Avg.Days.PM2.5))

# Map of Average Days PM2.5 by State in 2020
map_avg_PM2.5_2020 <- plot_usmap(data = data.map_avg_PM2.5_2020, values = "Avg.Days.PM2.5", labels = TRUE, label_color = "white") + labs(title = "Average Days PM2.5", subtitle = "2020") + scale_fill_continuous(type = "viridis", name = "Average Days PM2.5") + theme(legend.position = "right", plot.title = element_text(hjust = 0.5, face = "bold"), plot.subtitle = element_text(hjust = 0.5))

map_avg_PM2.5_2020$layers[[2]]$aes_params$size <- 2.5 #Change the size of the labels on the map
print(map_avg_PM2.5_2020)


```

**6. Maps migration by State 2012 and 2020**


```{r Migration outflows by State 2012 and 2020, echo=FALSE, message=FALSE, warning=FALSE}

##########################################
##  Map migrant outflows by State 2012  ##
##########################################

# Proportion of migrant outflows by State for 2012 (proportion is multiplied by 100, so it is read like a percentage)

data.map_migration_by_state_2012 <- AQI_Mig.outflows_by.state_2012_2020  %>% group_by(Year) %>%  dplyr::summarise(Prop.Migrants.outflows=(Migrants.outflows/sum(Migrants.outflows))*100, state=state) %>% filter(Year==2012) #%>% subset(select = c(state, Prop.Migrants.outflows))

# Map of Migrants' outflows by State for 2012
map_migration_by_state_2012 <- plot_usmap(data = data.map_migration_by_state_2012, values = "Prop.Migrants.outflows", labels = TRUE, label_color = "white") + labs(title = "Percentage of migrants' outflows by State", subtitle = "2012") + scale_fill_continuous(type = "viridis", name = "Percentage of migrants' outflows") + theme(legend.position = "right", plot.title = element_text(hjust = 0.5, face = "bold"), plot.subtitle = element_text(hjust = 0.5))

map_migration_by_state_2012$layers[[2]]$aes_params$size <- 2.5 #Change the size of the labels on the map
print(map_migration_by_state_2012)
...
data.map_migration_by_state_2020 <- AQI_Mig.outflows_by.state_2012_2020  %>% group_by(Year) %>%  dplyr::summarise(Prop.Migrants.outflows=(Migrants.outflows/sum(Migrants.outflows))*100, state=state) %>% filter(Year==2020) #%>% subset(select = c(state, Prop.Migrants.outflows))

# Map of Migrants' outflows by State for 2020
map_migration_by_state_2020 <- plot_usmap(data = data.map_migration_by_state_2020, values = "Prop.Migrants.outflows", labels = TRUE, label_color = "white") + labs(title = "Percentage of migrants' outflows by State", subtitle = "2020") + scale_fill_continuous(type = "viridis", name = "Percentage of migrants' outflows") + theme(legend.position = "right", plot.title = element_text(hjust = 0.5, face = "bold"), plot.subtitle = element_text(hjust = 0.5))

map_migration_by_state_2020$layers[[2]]$aes_params$size <- 2.5 #Change the size of the labels on the map
print(map_migration_by_state_2020)
