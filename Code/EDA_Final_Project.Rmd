...
```{r fig1, echo=FALSE, fig.cap="Average Unhealthy Days by State 2013"}
print(map_unhealthy_days_2013)
```

```{r fig2, echo=FALSE, fig.cap="Average Unhealthy Days by State 2020"}
print(map_unhealthy_days_2020)
```

```{r fig3, echo=FALSE, fig.cap="Average Max AQI value by State 2013"}
print(map_max_AQI_2013)
```

```{r fig4, echo=FALSE, fig.cap="Average Max AQI value by State 2020"}
print(map_max_AQI_2020)
```

```{r fig5, echo=FALSE, fig.cap="Average PM2.5 by State 2013"}
print(map_avg_PM2.5_2013)
```

```{r fig6, echo=FALSE, fig.cap="Average PM2.5 by State 2020"}
...
```{r fig7, echo=FALSE, fig.cap="Percentage of migrants' outflows by State in 2013"}
print(map_migration_by_state_2013)
```

```{r fig8, echo=FALSE, fig.cap=" Percentage of migrants' outflows by State in 2020"}
print(map_migration_by_state_2013)
```
